...
function ScheduleArea(props) {
    ...
    useEffect(() => {
        ...
        setIsCron(props.schedule ? !verifyDate(props.schedule) : false);
    }, [props.schedule])
                            ...
                            ? (
                                <React.Fragment>
                                    ...
                                    <div className="input-group input-group-merge">
                                        ...
                                        <input className="form-control" id="schedule" type="text" placeholder="* * * * * *" defaultValue={verifyDate(schedule) ? '' : schedule} onChange={onInputChange} />
                                    </div>
                                </React.Fragment>
                            )
                            : (
